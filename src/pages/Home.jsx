...
const Home = () => <section className="relative h-full flex items-center">
    <img src="/offer-bg.jpg" srcSet="/public/offer-bg@2x.jpg 2x" alt="Yelow camper near the lake" className="absolute inset-0 size-full object-cover -z-20" />
    ...
    <div className="container font-semibold text-theme-inputs leading-8">
        ...
        <NavLink className="block w-max py-4 px-14 rounded-full font-medium text-white bg-theme-btn hover:bg-theme-btn-hover" to="/catalog">View Now</NavLink>
    </div>
</section>
