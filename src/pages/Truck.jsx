      ...
      <section className="container">
          ...
          <ul className="flex gap-10 text-xl font-semibold border-b border-theme-gray-light">
            <li className="relative">
              <a
                ...
                className={
                  !hash || hash === "#features"
                    ? "after:absolute after:bottom-0 after:left-0 after:h-[5px] after:w-full after:translate-y-1/2 after:bg-theme-btn"
                    : "pb-6 block"
                }
              >
                Features
        ...
        <div className="flex gap-10 pt-11">
          <div className="w-[631px] flex-none">
            {(hash === "" || hash === "#features") && (
              <div className="bg-theme-inputs rounded-[10px] py-11 px-13">
                <Characteristics className="mb-[100px]" {...truck} />
                <span className="text-xl font-semibold pb-6 mb-6 border-b border-theme-gray-light block">
                  Vehicle details
                </span>
                <ul className="flex flex-col gap-4 font-medium">
                  <li className="flex justify-between">
                    Form <span className="capitalize">{truck.form}</span>
                  </li>
                  <li className="flex justify-between">
                    Length <span className="capitalize">{truck.length}</span>
                  </li>
                  <li className="flex justify-between">
                    Width <span className="capitalize">{truck.width}</span>
                  </li>
                  <li className="flex justify-between">
                    Height <span className="capitalize">{truck.height}</span>
                  </li>
                  <li className="flex justify-between">
                    Tank <span className="capitalize">{truck.tank}</span>
                  </li>
                  <li className="flex justify-between">
                    Consumption{" "}
                    <span className="capitalize">{truck.consumption}</span>
                  </li>
                </ul>
              </div>
            )}
