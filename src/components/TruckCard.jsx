...
const TruckCard = ({
  ...
  return (
    <div className="border border-theme-gray-light rounded-[20px] flex gap-6 p-6">
      <img
        src={gallery[0].thumb}
        alt={name}
        width={292}
      ...
      <div className="w-full flex flex-col">
        ...
        {/* truncate */}
        <div className="text-theme-text mb-6 line-clamp-1">{description}</div>
        <Characteristics className="mb-6" {...etc} />
        <NavLink
          className="block w-max py-4 px-14 rounded-full font-medium text-white bg-theme-btn hover:bg-theme-btn-hover"
          to={id}
        >
          Show more
        </NavLink>
