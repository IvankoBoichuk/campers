...
const BookingForm = () => <div className="w-full border border-theme-gray-light rounded-[10px] px-14 py-11">
    <span className="text-xl font-semibold mb-2">Book your campervan now</span>
    <p className="text-theme-gray mb-6">Stay connected! We are always ready to help you.</p>
    <Formik
    ...
    >
        {({ values, errors, touched, setFieldValue }) => (
            <Form className="flex flex-col space-y-[14px]">
                ...
                <Button className="mx-auto mt-6" type="submit">Submit</Button>
            </Form>
        )}
    </Formik>
